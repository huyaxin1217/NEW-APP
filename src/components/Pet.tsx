      ...
      <AnimatePresence>
        {showQuote && !hideSpeechBubble && (
          <motion.div
            ...
            className="absolute right-24 top-2 w-48 bg-white/5 px-3.5 py-2.5 rounded-2xl text-xs font-medium text-slate-500/50 border border-transparent z-20 whitespace-normal leading-relaxed text-left transition-all duration-300 pointer-events-none"
          >
            {quote}
            <div className="absolute right-[-4px] top-1/2 -translate-y-1/2 w-2 h-2 bg-white/5 rotate-45 border-t border-r border-transparent transition-all duration-300"></div>
          </motion.div>
        )}
      </AnimatePresence>
