        ...
        {importStep === 'list' && (
          ...
          >
            ...
            <div className="space-y-4 overflow-y-auto pb-24 hide-scrollbar">
              ...
              <BookCard
                title="考研核心词汇"
                desc="KAOYAN 必备单词 (9602词)"
                isCurrent={currentBook === 'KAOYAN'}
                onClick={() => onChangeBook('KAOYAN')}
              />
              <BookCard
                title="托福核心词汇"
                desc="TOEFL 必备单词 (13477词)"
                isCurrent={currentBook === 'TOEFL'}
                onClick={() => onChangeBook('TOEFL')}
              />
        ...
        {importStep === 'upload' && (
          ...
          >
            ...
            <div
              ...
              className={`flex-1 min-h-[250px] border-2 border-dashed rounded-3xl p-8 flex flex-col items-center justify-center text-center transition-all duration-300 ${cooldownText
